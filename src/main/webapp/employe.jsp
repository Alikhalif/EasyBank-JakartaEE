...
<div class="body_div">
  ...
  <div class="search-form">
    <form action="EmployeeServlet?action=get" method="POST">
          ...
          <tr>
            ...
            <td>
              <a href="javascript:void(0);" class="update-button"
                 onclick="populateUpdate('${employe.matricule}', '${employe.firstName}', '${employe.lastName}', '${employe.birthDate}', '${employe.phone}', '${employe.email}', '${employe.recruitmentDate}')">Update</a>
