...
<div class="body_div">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" class="update-button"
                               onclick="populateUpdateForm('${client.code}', '${client.firstName}', '${client.lastName}', '${client.birthDate}', '${client.phone}', '${client.address}')">Update</a>
    ...
    <div class="Add-Popup">
        ...
        <div id="popupForm" class="popup">
            <form action="ClientServlet?action=insert" method="post">
                <h2 style="margin-bottom: 5px; text-align: center;">Add Client</h2>
    ...
    <div class="Update-Popup">
        ...
        <div id="updatePopupForm" class="popup">
            <form action="ClientServlet?action=update" method="post">
                <h1 style="margin-bottom: 5px; text-align: center;">Update Client</h1>
                <label >CODE:</label>
    ...
    <div class="delete-popup">
        <form action="ClientServlet?action=delete" method="post">
